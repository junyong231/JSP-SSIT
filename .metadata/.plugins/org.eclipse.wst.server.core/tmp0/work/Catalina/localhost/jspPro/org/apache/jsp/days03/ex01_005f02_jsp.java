 ...
 * Generated at: 2024-10-17 01:33:51 UTC
...
/*
   ...
   */ 
	...
	try{
      ...
      out.write("\r\n");
      out.write("		<tr>\r\n");
      out.write("			<td><input  type=\"checkbox\" id=\"ckb_\" name=\"ckb_\" data-empno=\"");
      out.print( evo.getEmpno() );
      out.write("\"></td> \r\n");
      out.write("			<!-- 아이디 또는 val에 동적으로 empno 숨기기!  -->\r\n");
      out.write("			 ");
      out.write("\r\n");
      out.write("			<td>");
      out.print( evo.getEmpno() );
      ...
      out.write("	  // ex01_02.jsp?empno=1111&empno=2222....이런 형식으로\r\n");
      out.write("	 let empnos=[];\r\n");
      out.write("	 $(\"tbody :checkbox:checked\").each(function(i,elem){\r\n");
      out.write("		  \r\n");
      out.write("		 //jq 메서드 중 data()\r\n");
      out.write("		  let empno = $(elem).data(\"empno\");  // 이러면 data-empno의 속성값 얻어옴\r\n");
      ...
      out.write("	  $(\"table tbody tr\").find(\"td:first-child :checkbox\").prop(\"checked\", $(this).prop(\"checked\"))\r\n");
      out.write("})\r\n");
      out.write("\r\n");
      out.write("//하나라도 풀리면 전체선택 체크 풀리기\r\n");
