 ...
 * Generated at: 2024-10-17 07:15:15 UTC
...
public final class ex08_005fmain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("     관리자 혹은 일반 유저로 로그인 성공 시,\r\n");
      out.write("     리다이렉트로 도착하는 jsp 파일 \r\n");
      out.write("     리다이렉트: ex08.jsp 는 ex08_ok로 가려고 서버 갔는데 서버에서 main가라고 다시 보냄 (주소창 main) (요청 2번)\r\n");
      out.write("     포워딩 :  ex08.jsp 는 ex08_ok로 가려고 서버 감. 거기서 main에 대한 것 다 보내줌 (주소창 08_ok) (요청 1번)\r\n");
      out.write("     \r\n");
